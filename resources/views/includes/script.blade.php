<!-- BEGIN BASE JS -->
    ...
    <script src="{{URL::to('/')}}/assets/vendor/easy-pie-chart/jquery.easypiechart.min.js"></script>
    <script src="{{URL::to('/')}}/assets/vendor/chart.js/Chart.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
